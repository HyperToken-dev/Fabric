import { Activity, Boxes, KeyRound, LayoutDashboard, Radio } from 'lucide-react';
    ...
    <aside className="w-full bg-gradient-to-b from-emerald-50 via-teal-50 to-white text-slate-600 flex flex-col border-r border-emerald-100 md:h-screen md:w-64 md:fixed md:top-0 md:left-0">
      <div className="h-20 px-5 flex items-center gap-3 border-b border-emerald-100">
        ...
        <div className="min-w-0">
          <span className="block text-lg font-bold leading-tight tracking-tight text-emerald-950">Fabric</span>
          <span className="block text-[10px] font-semibold uppercase tracking-[0.18em] text-emerald-600">HyperToken</span>
        </div>
      </div>
